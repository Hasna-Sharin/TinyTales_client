                ...
                <div className="w-full  rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-[#FDF9F6] ">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div>
                            ...
                            <button type="submit" className="w-full text-white  bg-black hover:bg-black/75 focus:ring-black/75  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Create an account</button>
