...
const Post = ({blog,i}) => {
    ...
    return (
        <div className={`w-full flex flex-col gap-6 md:flex-row justify-between items-center border-2 bg-[#FDF9F6] shadow-md p-10 ${i % 2 !== 0 ? "md:flex-row-reverse" : "md:flex-row"}`}>
